...
val projectName = "smelter"
val projectVersion ="2019.02.27"

resolvers += Resolver.sonatypeRepo("snapshots")

val projectMainClass = "com.neo.sk.smelter.Boot"
...
lazy val backend = (project in file("backend")).enablePlugins(PackPlugin)
  ...
  .settings(
    ...
    packMain := Map("smelter" -> projectMainClass),
    packJvmOpts := Map("smelter" -> Seq("-Xmx64m", "-Xms32m")),
    packExtraClasspath := Map("smelter" -> Seq("."))
  )
  .settings(
